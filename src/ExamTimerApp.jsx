...
export default function ExamTimerApp() {
  ...
  return (
    <div className="p-4 w-[350px] h-[600px] bg-white border-2 border-gray-300 rounded-3xl shadow-2xl flex flex-col justify-between items-center font-sans">
      <h1 className="text-4xl text-blue-600 font-bold mt-2">📘</h1>
      {!settingsSubmitted ? (
